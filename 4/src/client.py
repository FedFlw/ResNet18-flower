...
class FlowerClient(fl.client.NumPyClient):
    ...
    def fit(self, parameters, config):
        ...
        trainloader = get_dataloader(self.cid, batch_size=32, workers=2, ty='train')
    ...
    def evaluate(self, parameters, config):
        self.set_parameters(parameters)
        valloader = get_dataloader(self.cid, batch_size=config["batch_size"], workers=config["num_cpu"], ty='test')
        self.net.to(self.device)
